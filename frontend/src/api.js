...
const API = {
  ...
  async register(email, password, name) {
    ...
    if (error) throw new Error(msg(error, "Échec de l'inscription")); return true;
  },
  ...
  async getTrees() {
    ...
    if (error) { console.warn("trees:", error.message); return []; } return data || [];
  },
  ...
  // Placeholders pour ne pas casser l'UI
